...
enum ast_control_frame_type {
	...
	AST_CONTROL_ATXFERCMD = 32,	/*!< AMI triggered attended transfer */
	AST_CONTROL_TOGGLE_PER_CALL_BARGE = 33,/*!< Toggle enable/disable per call barge in on SLA line */
	AST_CONTROL_HOLD_SAVANT = 34,
};
